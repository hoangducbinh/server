...
import {createTask, getAllTaskCompleted, getTasksForToday, getAllTaskbyCategory, getAllTasks, toggleTaskStatus, deleteTask,} from "../controllers/task.controller"
...
taskRoutes.route("/editTask/:id").put(toggleTaskStatus as any)
